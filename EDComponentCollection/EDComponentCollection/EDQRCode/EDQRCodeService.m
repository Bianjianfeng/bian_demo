...
#import "EDQRCodeService.h"

@implementation EDQRCodeService
...
+ (UIImage *)filterQRCode:(NSString *)source size:(CGFloat)size{
    CIImage *qrCImage = [EDQRCodeService createQRForString:source];
    UIImage *qrImage = [EDQRCodeService createNonInterpolatedUIImageFormCIImage:qrCImage withSize:size];
    return qrImage;
}
